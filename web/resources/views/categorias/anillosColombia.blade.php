...
@section('content') 
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="active">Anillos por mayor Colombia </li>
          </ul >
        </div>
      </div>
    </div>
  ...
  <section id="contact" class="padding_top">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <h1 class="uppercase heading bottom30">{{ $anillosColombia->name }} por mayor Colombia</h1>
        </div>
        
      </div>
      <img src="{{ asset('images/Anillos-oro-plata-valeny.png')}}" alt="anillos-oro-plata" class="img-responsive"  >
      <p>
        </p>

        <h4 class="uppercase heading bottom30">Anillos de oro y  plata ley 925  Colombia</h4>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4 text-right">
         <h5 class="result uppercase bottom30">Mostrando {{ $anillosColombia->joyas->count() }} resultados</h5>
      </div>
    </div>  
      ...
      <div class="col-md-3 col-sm-6">
        ...
        $nombre = str_replace(" ", "-", $joya->name);
          ...
          <div class="product_desc">
           ...
           <a href="{{ route('joyas.profile',[$nombre])}}"><p class="title">COTIZAR</p></a>
