...
@section('content') 
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <ul class="breadcrumb">
            ...
            <li class="active">Sets por mayor Colombia </li>
          </ul >
        </div>
      </div>
    </div>
  ...
  <section id="contact" class="padding_top">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <h1 class="uppercase heading bottom30">{{ $setsColombia->name }} por mayor Colombia</h1>
        </div>
        
      </div>
      <img src="{{ asset('images/sets-oro-plata-valeny.jpg')}}" alt="anillos-oro-plata" class="img-responsive"  >
      <p>
        </p>

        <h4 class="uppercase heading bottom30">Sets - Conjuntos - juegos de Oro y Plata ley 925 por mayor</h4>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4 text-right">
         <h5 class="result uppercase bottom30">Mostrando {{ $setsColombia->joyas->count() }} resultados</h5>
      </div>
    </div>  
    @foreach ($setsColombia->joyas as $joya) 
